...
while True:
  system("cls||clear")
  print(Fore.LIGHTRED_EX + "OrcunPars SMS BOMBER!!\n" + Style.RESET_ALL)
  print(Fore.LIGHTCYAN_EX + "Sms: {}\n".format(len(servisler_sms)) +
        Style.RESET_ALL)
  print(Fore.LIGHTGREEN_EX + " " + Style.RESET_ALL + "Created by " +
        Fore.LIGHTGREEN_EX + Style.BRIGHT + "OrçunPars\n" + Style.RESET_ALL)

  print(Fore.LIGHTMAGENTA_EX + "1- SMS Gönder")
  print("2- İletişim")
  print("3- Çıkış\n" + Fore.LIGHTYELLOW_EX)

  try:
    menu = int(input("Seçim: "))
  except ValueError:
  ...
  if menu == 1:
    ...
    try:
      print(
        Fore.LIGHTYELLOW_EX +
        "Telefon numarasını yazınız (başında '+90' olmadan)(birden fazla ise enter basın): "
        + Fore.LIGHTGREEN_EX,
        end="")
      tel_no = input()
      if tel_no != "" and len(str(tel_no)) == 10:
        tel_no2, tel_no3, tel_no4, tel_no5 = "bos", "bos", "bos", "bos"
      elif tel_no == "":
        system("cls||clear")
        print(
    ...
    print(Fore.LIGHTGREEN_EX +
          "Discord orcunpars | https://discord.gg/fgzvbDFj\n")

    print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Created by " +
          Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "OrçunPars\n" +
          Style.RESET_ALL)
    print(Fore.LIGHTRED_EX + "Menüye dönmek için 'enter' tuşuna basınız..")
    input()
  elif menu == 3:
    system("cls||clear")
    print(Fore.LIGHTRED_EX + "Çıkış yapıldı...")
    break
  else:
    print(Fore.LIGHTRED_EX + "Geçersiz seçim. Lütfen tekrar deneyiniz.")
    sleep(3)
